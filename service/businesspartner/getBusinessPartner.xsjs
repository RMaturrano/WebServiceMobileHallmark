...
function ObtenerDirecciones(codigo, database){
    ...
    try {
        ...
        var mQuery = 'SELECT T0."Address" AS "Codigo", ' +
                    	...
                    	'	IFNULL(T0."U_MSS_DVLU",\'N\') AS "VisitaLunes", ' +
                    	'	IFNULL(T0."U_MSS_DVMA",\'N\') AS "VisitaMartes", ' +
                    	'	IFNULL(T0."U_MSS_DVMI",\'N\') AS "VisitaMiercoles", ' +
                    	'	IFNULL(T0."U_MSS_DVJU",\'N\') AS "VisitaJueves", ' +
                    	'	IFNULL(T0."U_MSS_DVVI",\'N\') AS "VisitaViernes", ' +
                    	'	IFNULL(T0."U_MSS_DVSA",\'N\') AS "VisitaSabado", ' +
                    	'	IFNULL(T0."U_MSS_DVDO",\'N\') AS "VisitaDomingo", ' +
...
function GetDataSales(codigo, database){
    try{
        var mQuery = 'SELECT TOP 1 T0."DocNum" as "Codigo",  ' +
